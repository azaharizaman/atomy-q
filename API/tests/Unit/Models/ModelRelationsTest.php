...
final class ModelRelationsTest extends TestCase
{
    ...
    public static function relationProvider(): array
    {
        return [
            ...
            [new NormalizationSourceLine(), 'rfqLineItem', BelongsTo::class],
            ...
            [new Approval(), 'requestedBy', BelongsTo::class],
            [new Approval(), 'approvedByUser', BelongsTo::class],
            ...
            [new DecisionTrailEntry(), 'comparisonRun', BelongsTo::class],
