        ...
        if ($this->definitions->count() === 0) {
            $definitions = [
                ...
                new AiCapabilityDefinition(
                    ...
                    hasManualFallback: true,
                    fallbackUiMode: AiStatusSchema::FALLBACK_UI_MODE_SHOW_MANUAL_CONTINUITY_BANNER,
                    degradationMessageKey: 'ai.comparison_ai_overlay.degraded',
                    operatorCritical: true,
                    endpointGroup: AiStatusSchema::ENDPOINT_GROUP_COMPARISON_AWARD,
                ),
                new AiCapabilityDefinition(
                    featureKey: 'comparison_deterministic_matrix',
                    capabilityGroup: AiStatusSchema::CAPABILITY_GROUP_COMPARISON_INTELLIGENCE,
                    requiresAi: false,
                    hasManualFallback: true,
                    fallbackUiMode: AiStatusSchema::FALLBACK_UI_MODE_HIDE_AI_CONTROLS,
                    degradationMessageKey: 'ai.comparison_deterministic_matrix.available',
                    operatorCritical: true,
                    endpointGroup: AiStatusSchema::ENDPOINT_GROUP_COMPARISON_AWARD,
                ),
                new AiCapabilityDefinition(
                ...
                new AiCapabilityDefinition(
                    ...
                    hasManualFallback: true,
                    fallbackUiMode: AiStatusSchema::FALLBACK_UI_MODE_SHOW_MANUAL_CONTINUITY_BANNER,
                    degradationMessageKey: 'ai.award_ai_guidance.degraded',
                    operatorCritical: true,
                    endpointGroup: AiStatusSchema::ENDPOINT_GROUP_COMPARISON_AWARD,
                ),
                new AiCapabilityDefinition(
                    featureKey: 'award_manual_submission',
                    capabilityGroup: AiStatusSchema::CAPABILITY_GROUP_AWARD_INTELLIGENCE,
                    requiresAi: false,
                    hasManualFallback: true,
                    fallbackUiMode: AiStatusSchema::FALLBACK_UI_MODE_HIDE_AI_CONTROLS,
                    degradationMessageKey: 'ai.award_manual_submission.available',
                    operatorCritical: true,
                    endpointGroup: AiStatusSchema::ENDPOINT_GROUP_COMPARISON_AWARD,
                ),
                new AiCapabilityDefinition(
                    ...
                    hasManualFallback: true,
                    fallbackUiMode: AiStatusSchema::FALLBACK_UI_MODE_SHOW_MANUAL_CONTINUITY_BANNER,
                    degradationMessageKey: 'ai.approval_ai_summary.degraded',
                    operatorCritical: true,
                    endpointGroup: AiStatusSchema::ENDPOINT_GROUP_COMPARISON_AWARD,
                ),
                new AiCapabilityDefinition(
                    featureKey: 'approval_workflow_progression',
                    capabilityGroup: AiStatusSchema::CAPABILITY_GROUP_GOVERNANCE_INTELLIGENCE,
                    requiresAi: false,
                    hasManualFallback: true,
                    fallbackUiMode: AiStatusSchema::FALLBACK_UI_MODE_HIDE_AI_CONTROLS,
                    degradationMessageKey: 'ai.approval_workflow_progression.available',
                    operatorCritical: true,
                    endpointGroup: AiStatusSchema::ENDPOINT_GROUP_COMPARISON_AWARD,
                ),
                new AiCapabilityDefinition(
                ...
                new AiCapabilityDefinition(
                    ...
                    hasManualFallback: false,
                    fallbackUiMode: AiStatusSchema::FALLBACK_UI_MODE_SHOW_UNAVAILABLE_MESSAGE,
                    degradationMessageKey: 'ai.dashboard_ai_summary.unavailable',
                    operatorCritical: false,
                    endpointGroup: AiStatusSchema::ENDPOINT_GROUP_INSIGHT,
                ),
                new AiCapabilityDefinition(
                    ...
                    hasManualFallback: false,
                    fallbackUiMode: AiStatusSchema::FALLBACK_UI_MODE_SHOW_UNAVAILABLE_MESSAGE,
                    degradationMessageKey: 'ai.rfq_ai_insights.unavailable',
                    operatorCritical: false,
                    endpointGroup: AiStatusSchema::ENDPOINT_GROUP_INSIGHT,
                ),
                new AiCapabilityDefinition(
                ...
                new AiCapabilityDefinition(
                    ...
                    hasManualFallback: false,
                    fallbackUiMode: AiStatusSchema::FALLBACK_UI_MODE_SHOW_UNAVAILABLE_MESSAGE,
                    degradationMessageKey: 'ai.governance_ai_narrative.unavailable',
                    operatorCritical: false,
                    endpointGroup: AiStatusSchema::ENDPOINT_GROUP_GOVERNANCE,
                ),
                new AiCapabilityDefinition(
                    ...
                    hasManualFallback: true,
                    fallbackUiMode: AiStatusSchema::FALLBACK_UI_MODE_HIDE_AI_CONTROLS,
                    degradationMessageKey: 'ai.governance_manual_review.available',
                    operatorCritical: true,
                    endpointGroup: AiStatusSchema::ENDPOINT_GROUP_GOVERNANCE,
                ),
            ];
