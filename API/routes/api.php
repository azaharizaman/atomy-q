...
Route::middleware(['jwt.auth', 'tenant'])->group(function (): void {
    ...
    Route::prefix('approvals')->group(function (): void {
        ...
        Route::post('{id}/summary/generate', [ApprovalController::class, 'generateSummary']);
    ...
    Route::prefix('awards')->group(function (): void {
        ...
        Route::post('{id}/guidance/generate', [AwardController::class, 'generateGuidance']);
        Route::get('{id}/debrief-draft/{vendorId}', [AwardController::class, 'debriefDraft']);
        Route::post('{id}/debrief-draft/{vendorId}/generate', [AwardController::class, 'generateDebriefDraft']);
