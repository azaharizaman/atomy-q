...
export const v1VendorsStore = <ThrowOnError extends boolean = false>(options?: Options<V1VendorsStoreData, ThrowOnError>) => (options?.client ?? client).post<V1VendorsStoreResponses, unknown, ThrowOnError>({ url: '/vendors', ...options });
...
export const vendorUpdate = <ThrowOnError extends boolean = false>(options: Options<VendorUpdateData, ThrowOnError>) => (options.client ?? client).patch<VendorUpdateResponses, VendorUpdateErrors, ThrowOnError>({ url: '/vendors/{id}', ...options });
...
export const vendorGovernanceSanctionsScreening = <ThrowOnError extends boolean = false>(options: Options<VendorGovernanceSanctionsScreeningData, ThrowOnError>) => (options.client ?? client).post<VendorGovernanceSanctionsScreeningResponses, VendorGovernanceSanctionsScreeningErrors, ThrowOnError>({
