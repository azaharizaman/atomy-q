 ...
 * GET /approvals/:id
 */
export const approvalShow = <ThrowOnError extends boolean = false>(options: Options<ApprovalShowData, ThrowOnError>) => (options.client ?? client).get<ApprovalShowResponses, unknown, ThrowOnError>({ url: '/approvals/{id}', ...options });
 ...
 * Body: reason (required)
 */
export const approvalReject = <ThrowOnError extends boolean = false>(options: Options<ApprovalRejectData, ThrowOnError>) => (options.client ?? client).post<ApprovalRejectResponses, unknown, ThrowOnError>({ url: '/approvals/{id}/reject', ...options });
 ...
 */
export const authForgotPassword = <ThrowOnError extends boolean = false>(options: Options<AuthForgotPasswordData, ThrowOnError>) => (options.client ?? client).post<unknown, AuthForgotPasswordErrors, ThrowOnError>({
 ...
 * Scoped by tenant_id
 */
export const comparisonRunPreview = <ThrowOnError extends boolean = false>(options?: Options<ComparisonRunPreviewData, ThrowOnError>) => (options?.client ?? client).post<ComparisonRunPreviewResponses, unknown, ThrowOnError>({ url: '/comparison-runs/preview', ...options });
 ...
 * Scoped by tenant_id
 */
export const comparisonRunMatrix = <ThrowOnError extends boolean = false>(options: Options<ComparisonRunMatrixData, ThrowOnError>) => (options.client ?? client).get<ComparisonRunMatrixResponses, unknown, ThrowOnError>({ url: '/comparison-runs/{id}/matrix', ...options });

/**
 * GET /comparison-runs/:id/readiness
 * Scoped by tenant_id
 */
export const comparisonRunReadiness = <ThrowOnError extends boolean = false>(options: Options<ComparisonRunReadinessData, ThrowOnError>) => (options.client ?? client).get<ComparisonRunReadinessResponses, unknown, ThrowOnError>({ url: '/comparison-runs/{id}/readiness', ...options });

/**
 * PATCH /comparison-runs/:id/scoring-model
 * Scoped by tenant_id
 */
export const comparisonRunUpdateScoringModel = <ThrowOnError extends boolean = false>(options: Options<ComparisonRunUpdateScoringModelData, ThrowOnError>) => (options.client ?? client).patch<ComparisonRunUpdateScoringModelResponses, unknown, ThrowOnError>({ url: '/comparison-runs/{id}/scoring-model', ...options });

/**
 * POST /comparison-runs/:id/lock
 * Scoped by tenant_id
 */
export const comparisonRunLock = <ThrowOnError extends boolean = false>(options: Options<ComparisonRunLockData, ThrowOnError>) => (options.client ?? client).post<ComparisonRunLockResponses, unknown, ThrowOnError>({ url: '/comparison-runs/{id}/lock', ...options });

/**
 * POST /comparison-runs/:id/unlock
 * Scoped by tenant_id
 */
export const comparisonRunUnlock = <ThrowOnError extends boolean = false>(options: Options<ComparisonRunUnlockData, ThrowOnError>) => (options.client ?? client).post<ComparisonRunUnlockResponses, unknown, ThrowOnError>({ url: '/comparison-runs/{id}/unlock', ...options });
 ...
 * POST /users/invite
 */
export const userInvite = <ThrowOnError extends boolean = false>(options?: Options<UserInviteData, ThrowOnError>) => (options?.client ?? client).post<UserInviteResponses, unknown, ThrowOnError>({ url: '/users/invite', ...options });
 ...
 * PUT /users/:id
 */
export const userUpdate = <ThrowOnError extends boolean = false>(options: Options<UserUpdateData, ThrowOnError>) => (options.client ?? client).put<UserUpdateResponses, unknown, ThrowOnError>({ url: '/users/{id}', ...options });
 ...
 */
export const userDelegationRules = <ThrowOnError extends boolean = false>(options: Options<UserDelegationRulesData, ThrowOnError>) => (options.client ?? client).get<UserDelegationRulesResponses, unknown, ThrowOnError>({ url: '/users/{id}/delegation-rules', ...options });
 ...
 */
export const userUpdateDelegationRules = <ThrowOnError extends boolean = false>(options: Options<UserUpdateDelegationRulesData, ThrowOnError>) => (options.client ?? client).put<UserUpdateDelegationRulesResponses, unknown, ThrowOnError>({ url: '/users/{id}/delegation-rules', ...options });
 ...
 */
export const userUpdateAuthorityLimits = <ThrowOnError extends boolean = false>(options: Options<UserUpdateAuthorityLimitsData, ThrowOnError>) => (options.client ?? client).put<UserUpdateAuthorityLimitsResponses, unknown, ThrowOnError>({ url: '/users/{id}/authority-limits', ...options });
...
export const vendorShow = <ThrowOnError extends boolean = false>(options: Options<VendorShowData, ThrowOnError>) => (options.client ?? client).get<VendorShowResponses, unknown, ThrowOnError>({ url: '/vendors/{id}', ...options });

export const vendorPerformance = <ThrowOnError extends boolean = false>(options: Options<VendorPerformanceData, ThrowOnError>) => (options.client ?? client).get<VendorPerformanceResponses, unknown, ThrowOnError>({ url: '/vendors/{id}/performance', ...options });

export const vendorCompliance = <ThrowOnError extends boolean = false>(options: Options<VendorComplianceData, ThrowOnError>) => (options.client ?? client).get<VendorComplianceResponses, unknown, ThrowOnError>({ url: '/vendors/{id}/compliance', ...options });

export const vendorHistory = <ThrowOnError extends boolean = false>(options: Options<VendorHistoryData, ThrowOnError>) => (options.client ?? client).get<VendorHistoryResponses, unknown, ThrowOnError>({ url: '/vendors/{id}/history', ...options });
