...
export const vendorStore = <ThrowOnError extends boolean = false>(options: Options<VendorStoreData, ThrowOnError>) => (options.client ?? client).post<VendorStoreResponses, VendorStoreErrors, ThrowOnError>({
    url: '/vendors',
    ...options,
    headers: {
        'Content-Type': 'application/json',
...
export const vendorUpdateStatus = <ThrowOnError extends boolean = false>(options: Options<VendorUpdateStatusData, ThrowOnError>) => (options.client ?? client).patch<VendorUpdateStatusResponses, VendorUpdateStatusErrors, ThrowOnError>({
...
export const vendorRecommendationStore = <ThrowOnError extends boolean = false>(options: Options<VendorRecommendationStoreData, ThrowOnError>) => (options.client ?? client).post<VendorRecommendationStoreResponses, VendorRecommendationStoreErrors, ThrowOnError>({
