...
## Latest Task 4 Live-Mode Fail-Loud Evidence - 2026-04-17
...
| A3: Eliminate live-mode seed fallback on golden path | Closed locally | WEB build, Task 4 page unavailable-state tests, and the full live-hook matrix all pass with `NEXT_PUBLIC_USE_MOCKS=false` as of 2026-04-17. | WEB + Backend quote intake |
