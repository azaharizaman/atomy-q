...
final class ProtectedEndpointsTest extends ApiTestCase
{
    ...
    public static function endpointMatrix(): array
    {
        $matrix = [
            ...
            ['GET', '/api/v1/rfqs/rfq-1/evidence-vault', []],
            ['POST', '/api/v1/rfqs/rfq-1/evidence-vault/supporting-evidence', []],
            ['POST', '/api/v1/rfqs/rfq-1/evidence-vault/award-pack/finalize', []],
            ['GET', '/api/v1/rfqs/rfq-1/evidence-vault/award-pack/export', []],
