...
const STATUS_MAP: Record<StatusVariant, StatusConfig> = {
  ...
  cancelled:  { label: 'Cancelled',  className: 'bg-red-50 text-red-700 border border-red-200',         icon: <XCircle size={11} />,                  dot: false },
  published:  { label: 'Published',  className: 'bg-blue-50 text-blue-700 border border-blue-200',      icon: undefined,                                   dot: true  },
};
