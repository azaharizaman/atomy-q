        ...
        >
          ...
          <div className="relative z-10 flex w-full min-w-0">
            {steps.map((step, idx) => {
              ...
              const leftTone =
                idx > 0 ? segmentToneAfterStep(steps[idx - 1]!, step) : null;
              const rightTone =
                idx < n - 1 ? segmentToneAfterStep(step, steps[idx + 1]!) : null;
              ...
              return (
                ...
                >
                  ...
                  <div className="mt-2 flex flex-col items-center px-0.5">
