...
// ─── Pipeline Stat Card ───────────────────────────────────────────────────────
/** Compact count + label card for pipeline metrics (Active, Pending, etc.) */
...
export function PipelineStatCard({ label, count, icon, onClick, className = '' }: PipelineStatCardProps) {
  return (
    <div
      onClick={onClick}
      className={[
        'flex items-center justify-between p-4 rounded-lg border border-slate-200 bg-white',
...
/** Prominent savings/value card with optional trend */
...
// ─── SLA Alert Card ────────────────────────────────────────────────────────────
/** Urgency-based alert card for approvals, deadlines, submissions */
...
/** Recent activity list with optional "View all" action */
...
/** List of items awaiting approval with assignee and type */
...
/** Bar or list view of spend/count by category */
...
// ─── Quick Action Card ─────────────────────────────────────────────────────────
/** Icon + title + optional action for dashboard CTAs */
